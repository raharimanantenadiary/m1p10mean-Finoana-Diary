...
const {save,findByClient,ajoutDiagnostic,historiqueReparation, findAllReparation,updateDiagnostic,deleteDiagnostic,finirReparation, findReparationByDepot,findReparationByvoiture,findAllReparationFin ,findReparationByvoitureEtatFin} = require('../controller/ReparationController') ;
/* GET users listing. */
...
router.get('/findRep/:idreparation/:idvoiture',findReparationByvoitureEtatFin);
